...
**A1**  under_10k = 9,310   10k_50k = 15,403  50k_100k = 3,968  100k_500k = 4,132  
500k_1m = 539   1m_plus = 356

```{r}
# Write the code to produce your answer here
west_virginia_loan <- west_virginia_ppp %>%
  mutate(
   loan_range = case_when(
...
**A2** Harvest Small Business Finance, LLC; 139
...
**A3** Most of them are banks or mortgage firms. 
...
```{r}
# Write the code to produce your answer here
west_virginia_monthly <- west_virginia_ppp %>%
