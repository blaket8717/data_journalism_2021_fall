...
**Answer** Some cities are spelled a different way and are registered as a separate city. 
...
**Answer** 	PHOENIX changed to Phoenix, and WESTMINSTER changed to Westminster
...
**Answer** 	ABELL changed to Abell, 	aberdeen changed to Aberdeen, and ABERDEEN PROVING GROUND changed to Aberdeen Proving Ground
...
**Answer** No, not really. It looks the same. 
