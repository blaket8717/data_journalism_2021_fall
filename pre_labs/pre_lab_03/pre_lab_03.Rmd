...
**Answer**: 135073; yes it is. The count stays consistent throughout every task, no matter the forgiveness date or forgiveness amount. 
```{r}
ppp_maryland_loans %>%
...
**Answer** 10000000; 6. It is suspicious to me because I don't know what is in the middle. The number between 6-1000000, anything could be the average in that range. 
```{r}
...
**Answer** 
The amount column is stored as a character, not a number.
The city field has five different forms – including misspellings – of Arnold.
The zip field mixes five digit ZIP codes and nine digit ZIP codes.
...
**Answer** There is an "x" in front of "1_id"
...
There needs to be a group_by, mutate, and other functions to support this.
...
**Answer** I ran the code as instructed.
