...
**Answer** I see the U.S. Bureau of Labor Statistics. Along with the CES program, which breaks down the industries and how they are classified.
...
**Answer** I see code for an HTML document. I'm actually familiar with a lot of the code that appears.
...
**Answer** Simple HTML code, typically this head tag is always in between the HTML tag and body tag.
...
**Task** Follow the directions in the previous paragraph. Briefly describe what you see there.
**Answer** The terminal for the web page, where all the code is stored. 
...
**Answer** All 7 different from the web page.  
...
**Task** Follow the directions in the previous paragraph. Briefly describe what you see there.
**Answer** 6 different tables, broken down by how many rows and columns.
...
**Answer** One of the data tables from the web page, now on R. 
...
**Task** Follow the directions in the previous paragraph. Briefly describe what you see there.
**Answer** Table 2 from the web page titled "NAICS Sectors".
...
**Answer** Dataframe of table 2 from the webpage.
...
**Answer** A much more clean table 2 from the web page. Not spaced apart.
...
**Answer** Our same dataframe from task 18 on the last chapter.
```{r}
...
**Task** Visit the web page linked above. Briefly describe what you see there.
**Answer** Data centered around utilities and employment under that occupation.
...
**Task** Run the following code to read in the html. Briefly describe the output that appears below the codeblock.
**Answer** HTML code that needs to be anazlyzed and cleaned up. 
...
**Answer** The table that is needed for our pre_lab (table with employment information).
...
**Answer** A data frame of the utilities employment information. 
...
**Answer** Now only one row appears from the table.
...
**Task** Visit the web page linked above. Briefly describe what you see there.
**Answer** Industries that are based on mining, quarrying, and oil and gas extraction.
...
**Task** Visit the web page linked above. Briefly describe what you see there.
**Answer** Industries based on construction. 
...
**Answer** This code displays any word after print appears on the page.
```{r}
...
**Answer** list_of_sectors appears in the environment tab.
```{r}
...
**Answer** Now we have sector appearing in the environment tab, content shared with list_of_sectors.
```{r}
...
**Answer** An error appears. The sector_list doesn't exist.
...
**Task** Run the following code to use a for loop to print list of sectors. Briefly describe the output that appears below the codeblock.
**Answer** Now in our enviroment tab, we have a value called x. Looped with list_of_sectors.
```{r}
# Define list of sectors
list_of_sectors <- c("Agriculture, Forestry, Fishing and Hunting", "Mining, Quarrying, and Oil and Gas Extraction", "Utilities", "Construction", "Manufacturing",
"Wholesale Trade", "Retail Trade", "Transportation and Warehousing", "Information", "Finance and Insurance")
...
**Task** Run the following code to use a for loop to print list of sectors. Briefly describe the output that appears below the codeblock.
**Answer** Error appears that says it can't print sector_name.
```{r, error=TRUE}
# Define list of sectors
list_of_sectors <- c("Agriculture, Forestry, Fishing and Hunting", "Mining, Quarrying, and Oil and Gas Extraction", "Utilities", "Construction", "Manufacturing",
"Wholesale Trade", "Retail Trade", "Transportation and Warehousing", "Information", "Finance and Insurance")
...
**Answer** List of number 1-10. A value appears in the enviorment tab that says number.
```{r}
# For loop that includes instructions that refer to a variable that doesn't exist.
for (number in 1:10) {
  print(number)
...
**Answer** A data frame that breaks down all different types of occupations, cleaned and spearated.
...
**Answer** There are 20 rows in the naics_indusry. 
...
**Answer** Environment tab has a value saying row_number. A list 1-20 appears.
...
**Answer** The same information we had earlier when we broke it down by one row.
...
**Task** Run the following code to load table from last chapter. Briefly describe the output that appears below the codeblock.
**Answer** naics_url appears in environment tab. All occupations appear in one data frame.
```{r}
# Define url of page we want to scrape
...
**Answer** URL is now attached to each occupation in the data frame.
...
**Answer** Now we can see the sector_xpath_id in the data frame.
...
**Answer** Public Information row has been removed on the second page of the data frame.
...
**Answer** All 19 rows having their own seperate data frame.
...
**Answer** The data frame that expands on each row and the URL attached to it.
```{r}
...
**Answer** Now all 19 rows have their own data frames and also informative data in each table.
...
**Answer** Much cleaner, now each data frame has one row.
...
**Answer** Another value in the enviroment tab. Sector url and xpath appear in the data frame.
...
**Task** Run the following for loop to clean up tables. Briefly describe the output that appears below the codeblock.
**Answer** Tables are clean and now show only one number representing the number of employees. 
...
**Answer** Now we have our data frame tied with how many employees were in June 2021.
...
**Task** Visit the web page linked above. Briefly describe what you see there.
**Answer** We are back to our Mining, Quarrying, and Oil and Gas Extraction sector
...
**Task** Visit the web page linked above. Briefly describe what you see there.
**Answer** A new web page! Now we focus on Agriculture, Forestry, Fishing, and Hunting occupations.
...
**Answer** All 19 rows have been cleaned and agriculture information has been removed.
