...
**Answer** This DF describes all of Marylanders that have received the vaccine in some capacity. 
...
**Answer** There is a row dedicated to "unknown" and "na".
...
**Answer**  All of the people that registered in a NA county.
...
**Answer** There is a sudden decrease in vaccinations, except for the 12th.
...
**Answer** April was the peak of vaccinations, but as time goes by, the vaccinations decrease because most people already have them, or decided not to get it at all.
...
**Answer** Kind of difficult to tell which shade of blue is which. There is a line chart that doesn't label each county. Blue lines are leading in this chart.
...
**Task** Run the following code and describe what the resulting chart shows
**Answer** Now the lines have changed motion and now it makes an upward shift toward the right. 
...
**Answer** COVID-19 cases that have happened in the state of MD separated by counties on the 14th of Nov.
