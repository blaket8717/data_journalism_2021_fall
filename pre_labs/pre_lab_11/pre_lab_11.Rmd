...
**Answer** Several different types of documents of every Hosipital in America.
...
**Answer** The unfiltered code that runs when running this dataset. In the dataset, there are columns like name, address, exact location of each hospital, and population. 
...
**Answer** Names of hosiptals are listed, specifically MD, and the urls are displayed in the space below. 
...
### Task: Run code
**Task** Run the following code. Describe the output in the space below.
**Answer** The number of different types of hospitals in Maryland. 
...
### Task: Run code
**Task** Run the following code. Describe the output in the space below.
**Answer** We are breaking down which type of hospital, General Acute Care, that we are filtering. 
...
### Task: Run code
**Task** Run the following code. Describe the output in the space below.
**Answer** A plot chart of the hospital locations in MD. You can see the state of MD in the dots.
...
### Task: Run code
**Task** Run the following code. Describe the output in the space below.
**Answer** The tigris library ran properly.
...
### Task: Run code
**Task** Run the following code. Describe the output in the space below.
**Answer** A dataframe is made with all of the counties in the country aligned with their statefp.
```{r}
...
### Task: Run code
**Task** Run the following code. Describe the output in the space below.
**Answer** Now we are looking at a dataframe of the counties in MD.
...
### Task: Run code
**Task** Run the following code. Describe the output in the space below.
**Answer** The state of Maryland appears with the county lines.  
...
### Task: Run code
**Task** Run the following code. Describe the output in the space below.
**Answer** Now on the map of MD, we can see the locations of MD hospitals by the county it is in.
...
### Task: Run code
**Task** Run the following code. Describe the output in the space below.
**Answer** A map showing the amount of beds in each hospital using a color code. 
...
**Answer** The following code ran with my API key. 
...
### Task: Run code
**Task** Run the following code. Describe the output in the space below.
**Answer** Unfiltered code that shows all General Acute Care hospitals in MD. 
...
### Task: Run code
**Task** Run the following code. Describe the output in the space below.
**Answer** A dataframe with the count of beds for hospitals in MD.
...
### Task: Run code
**Task** Run the following code. Describe the output in the space below.
**Answer** A dataset that shows the population for each county in MD.
...
### Task: Run code
**Task** Run the following code. Describe the output in the space below.
**Answer** The geometry is displayed on the dataframe to see where each county is located in MD.
...
### Task: Run code
**Task** Run the following code. Describe the output in the space below.
**Answer** A dataframe with hospital beds per county. 
...
### Task: Run code
**Task** Run the following code. Describe the output in the space below.
**Answer** Now the geometry appears in the dataframe in order to locate the county. 
...
### Task: Run code
**Task** Run the following code. Describe the output in the space below.
**Answer** Now we have a dataframe for beds per 100k people in a county of Md. 
...
### Task: Run code
**Task** Run the following code. Describe the output in the space below.
**Answer** Replaced any beds that said NA to the number zero. 
...
### Task: Run code
**Task** Run the following code. Describe the output in the space below.
**Answer** Beds per 100k is now arranged in order and we see the population and amount of beds with it. 
...
### Task: Run code
**Task** Run the following code. Describe the output in the space below.
**Answer** A map that displays the most beds in MD by county with a color code. 
...
### Task: Run code
**Task** Run the following code. Describe the output in the space below.
**Answer** Now we changed the color code from blue to magma. 
...
**Answer** The Northern and Eastern areas of MD have the most hospital beds, while the southwestern area, D.C., lacks beds in hospitals.
