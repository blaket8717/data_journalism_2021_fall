...
**Answer** https://app.datawrapper.de/chart/tj9B4/publish 
...
**Answer** The code below subsets the dataframe of Maryland PPP data and grouped them by county and number of loans.
...
**Answer** Now the code is showing counties that have above 6 loans for the entire county.
...
**Answer** Gives us the first two digits for each zip code. Previously only provided last 3 digits.
...
**Answer** Now the state codes and counties align up with the fips code and their counties. 
...
**Answer** The map was originally grey and showing the entire country, now we get the counties within Maryland. Datawrapper detected which areas were colored.
...
**Answer** Now we get the county name and a more proper digit with commas in between digits. 
...
**Answer** https://app.datawrapper.de/map/jprB7/publish 
