...
**Answer** Yes, they do have the same column structure. 
...
**Answer** "Error: Can't join on `x$zip` x `y$zip` because of incompatible types. ℹ `x$zip` is of type <character>>. ℹ `y$zip` is of type <double>>." The two zip files need to be mutated to be compatible. 
...
**Answer** Number: 44032; Average: 53836.46; Median: 20000
...
**Answer** Number: 113937; Average: 88140.24; Median: 20833
...
**Answer** Number: 44,032; Average: 49,098.70; Median: 19,810.50
...
**Answer** Number: 56,968.50; Average: 164,605.28; Median: 20,833
