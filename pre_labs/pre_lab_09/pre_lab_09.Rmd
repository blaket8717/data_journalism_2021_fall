...
**Answer** First step is grabbing all of the project_county name, totaling all of the loans, and arranging from largest to smallest. 
...
**Answer** A blank graph, but it is formatted for a graph.
...
**Task** Run the following code. Explain what you see after running the code in the space below.
**Answer** A bar graph representing the total loans in Maryland by county.
...
**Answer** Now our columns are in order. Previous one was much more scattered. 
...
**Task** Run the following code. Explain what you see after running the code in the space below. What has changed from the last codeblock?
**Answer** Rotated the graph to make it look horizontal.
...
**Task** Run the following code. Explain what you see after running the code in the space below. What has changed from the last codeblock?
**Answer** A lot more white appears in the background of this graph.
...
**Answer** A lot more detail in the background of the chart. Looks like something that will appear on a web page.
```{r}
maryland_ppp_top_counties %>%
  ggplot() +
  geom_bar(aes(x=reorder(project_county_name,total_loans), weight=total_loans)) +
...
**Task** Run the following code. Explain what you see after running the code in the space below. What has changed from the last codeblock?
**Answer** Titles and headers are now labeled on the graph. 
...
**Task** Run the following code. Explain what you see after running the code in the space below. 
**Answer** Now the total amount of loans, but this time by the date of the loans. 
...
**Task** Run the following code. Explain what you see after running the code in the space below. 
**Answer** Now a line graph apppears order by the date of the loans.
...
**Task** Run the following code. Explain what you see after running the code in the space below. 
**Answer** A lot more breaks in the graph to differenitiate the dates from a more in-depth perspective.
...
**Task** Run the following code. Explain what you see after running the code in the space below. 
**Answer** Now, the graph is clean and much easier to read. 
```{r}
ppp_maryland_loans_by_date %>%
  ggplot() + 
  geom_line(aes(x=date_approved, y=total_loans)) + 
